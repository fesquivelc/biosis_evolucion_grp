        ...
        for (Asistencia asistencia : registroAsistencia) {
            ...
            if (asistencia.getResultado() == AnalizadorAsistencia.ASISTENCIA) {
                ...
                for (DetalleAsistencia detalle : asistencia.getDetalleAsistenciaList()) {
                    ...
                    if (tipo == AnalizadorAsistencia.TARDANZA || tipo == AnalizadorAsistencia.MARCACION_PENDIENTE) {
...
//                    detalleAsistencia.getHoraEvento()[contador] = detalle.getHoraEvento();
                    ...
                    if(contador == marcacionesMaximas.intValue() && tipo != AnalizadorAsistencia.FALTA && !detalle.isPermiso() && detalle.getHoraEvento() != null){
...
//        System.out.println("CONTEO: "+conteo.intValue());
        ...
        if (marcacionesPendientes == conteo) {
            ...
            return AnalizadorAsistencia.MARCACION_PENDIENTE;
        } else if (hayTardanza) {
